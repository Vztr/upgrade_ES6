...
let usersName =users1.map(user => user.name);
...
/* 4.3 Dado el siguiente array, devuelve una lista que contenga los valores de la propiedad .name y añade al valor de .name el string ' (Visitado)' cuando el
...
let visitedCity = cities.map((city) => {
